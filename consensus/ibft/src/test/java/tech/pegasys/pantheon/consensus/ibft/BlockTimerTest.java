...
public class BlockTimerTest {
  ...
  @Test
  public void anBlockTimerExpirtyEventIsAddedToTheQueueOnExpiry() {
    ...
    // Verify that the event will not be added to the queue immeditaley
  ...
  @Test
  public void eventIsImmediatelyAddeToTheQueueIfAbsoluteExpiryIsEqualToNow() {
    final long MINIMAL_TIME_BETWEEN_BLOCKS_MILLIS = 15_000;
  ...
  @Test
  public void eventIsImmediatelyAddeToTheQueueIfAbsoluteExpiryIsInThePast() {
    final long MINIMAL_TIME_BETWEEN_BLOCKS_MILLIS = 15_000;
